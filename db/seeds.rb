...
encanto = Movie.create!(title:"Encanto", year: 2021, film_rating: "  •  "+"PG", description:"A young Colombian girl has to face the frustration of being the only member of her family without magical powers.")
encanto.photo.attach(io: open("https://eyemdbee-dev.s3.us-east-2.amazonaws.com/movies/encanto.jpg"), filename:'encanto.jpg')

eternals = Movie.create!(title:"Eternals", year: 2021, film_rating: "  •  "+"PG-13", description:"Following the events of Avengers: Endgame (2019), an unexpected tragedy forces the Eternals, ancient aliens who have been living on Earth in secret for thousands of years, out of the shadows to reunite against mankind's most ancient enemy, the Deviants.")
eternals.photo.attach(io: open("https://eyemdbee-dev.s3.us-east-2.amazonaws.com/movies/eternals.jpg"), filename:'eternals.jpg')

dune = Movie.create!(title: "Dune", year: 2021, film_rating: "  •  "+"PG-13"+"  •  ", duration: "2h 35min", description: "A mythic and emotionally charged hero's journey, 'Dune' tells the story of Paul Atreides, a brilliant and gifted young man born into a great destiny beyond his understanding, must travel to the most dangerous planet in the universe to ensure the future of his family and his people. As malevolent forces explode into conflict over the planet's exclusive supply of the most precious resource in existence-a commodity capable of unlocking humanity's greatest potential-only those who can conquer their fear will survive.")
dune.photo.attach(io: open("https://eyemdbee-dev.s3.us-east-2.amazonaws.com/movies/Dune"), filename:'Dune.jpg')

ghostbusters = Movie.create!(title:"Ghostbusters: Afterlife", year: 2021, film_rating: "  •  "+"PG-13", description:"When a single mom and her two kids arrive in a small town, they begin to discover their connection to the original Ghostbusters and the secret legacy their grandfather left behind.")
...
kingRichard = Movie.create!(title:"King Richard", year: 2021, film_rating: "  •  "+"PG-13"+"  •  ", duration: "2h 18min", description:"A look at how tennis superstars Venus and Serena Williams became who they are after the coaching from their father Richard Williams.")
...
spencer = Movie.create!(title:"Spencer", year: 2021, film_rating: "  •  "+"R"+"  •  ", duration: "1h 51min", description:"During her Christmas holidays with the royal family at the Sandringham estate in Norfolk, England, Diana decides to leave her marriage to Prince Charles.")
...
theFrenchDispatch = Movie.create!(title:"The French Dispatch", year: 2021, film_rating: "  •  "+"R"+"  •  ", duration: "1h 48min", description:"A love letter to journalists set in an outpost of an American newspaper in a fictional twentieth century French city that brings to life a collection of stories published in 'The French Dispatch Magazine'.")
...
theKingsMan = Movie.create!(title:"The King's Man", year: 2021, film_rating: "  •  "+"R", description:"In the early years of the 20th century, the Kingsman agency is formed to stand against a cabal plotting a war to wipe out millions.")
...
the355 = Movie.create!(title:"The 355", year: 2022, film_rating: "  •  "+"PG-13", description:"When a top-secret weapon falls into mercenary hands, wild card CIA agent Mason 'Mace' Brown will need to join forces with rival badass German agent Marie, former MI6 ally and cutting-edge computer specialist Khadijah, and skilled Colombian psychologist Graciela on a lethal, breakneck mission to retrieve it, while also staying one-step ahead of a mysterious woman, Lin Mi Sheng, who is tracking their every move. As the action rockets around the globe from the cafes of Paris to the markets of Morocco to the wealth and glamour of Shanghai, the quartet of women will forge a tenuous loyalty that could protect the world-or get them killed.")
the355.photo.attach(io: open("https://eyemdbee-dev.s3.us-east-2.amazonaws.com/movies/the355.jpg"), filename:'the355.jpg')

topGun = Movie.create!(title:"Top Gun: Maverick", year: 2022, film_rating: "  •  "+"PG-13", description:"After more than thirty years of service as one of the Navy's top aviators, Pete Mitchell is where he belongs, pushing the envelope as a courageous test pilot and dodging the advancement in rank that would ground him.")
topGun.photo.attach(io: open("https://eyemdbee-dev.s3.us-east-2.amazonaws.com/movies/top-gun.jpg"), filename:'top-gun.jpg')

westSideStory = Movie.create!(title:"West Side Story", year: 2021, film_rating: "  •  "+"PG-13", description:"An adaptation of the 1957 musical, West Side Story explores forbidden love and the rivalry between the Jets and the Sharks, two teenage street gangs of different ethnic backgrounds.")
